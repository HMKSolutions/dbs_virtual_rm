...
export default {
  ...
  methods: {
    ...
    updateRate(rate) {
      console.log("updating rate wtv that is");
      // db.collection("users")
    ...
    updateExperience() {
      console.log("updating experience so probably the jobs experiecne or education");
      // db.collection("users")
      //   .doc(firebase.auth().currentUser.uid)
      //   .collection("modules")
    ...
    deleteExperience(experience) {
      console.log("deleting experience of users");
      // db.collection("users")
      //   .doc(firebase.auth().currentUser.uid)
      //   .collection("modules")
    ...
    fetchEverything() {
      console.log("getting everything to do with users");
      // db.collection("users")
      //   .doc(firebase.auth().currentUser.uid)
      //   .collection("modules")
      //   .get()
    ...
    updateBusiness() {
      console.log("update users business");
      // db.collection("users")
      //   .doc(firebase.auth().currentUser.uid)
      //   .collection("business")
